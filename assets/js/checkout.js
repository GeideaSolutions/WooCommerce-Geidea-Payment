...
const geidea_title = window.wp.i18n.__(geidea_data.title || 'Geidea', 'geidea');
...
window.wc.wcBlocksRegistry.registerPaymentMethod(Geidea_Block_Gateway);