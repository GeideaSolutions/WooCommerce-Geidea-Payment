...
if ($env === "EGY-PROD") {
    ...
    return [
        "payByTokenUrl" => "https://api.geidea.ae/pgw/api/v1/direct/pay/token",
        "refundUrl" => "https://api.geidea.ae/pgw/api/v1/direct/refund",
        "merchantConfigUrl" => "https://api.geidea.ae/pgw/api/v1/config",
        "jsSdkUrl" => "https://payments.geidea.ae/hpp/geideaCheckout.min.js",
